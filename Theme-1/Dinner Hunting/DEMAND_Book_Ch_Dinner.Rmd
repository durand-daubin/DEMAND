...
Now we report the results of coding 'food preparation,cooking' (cooking) and 'meals/snacks' (eating) for the UK.
...
cookEpsW <- svytable(~ba_survey.x + sex + is_cooking_m, # the row * columns we want
