...
## Unweighted eating and cooking episodes
...
kable(caption = "Distribution of food preparation/cooking episodes by survey year (unweighted)",
  mtusUKEpisodes_DT[,
                    ...
                    by = .(ba_survey,sex) # ba_survey pools 1983/4 and 1987
                    ]
  )
```
...
## Weighted cooking and eating as main activities
...
The following table shows the weighted proportion of episodes which were reported as cooking as a main activity by men and women in each survey.
...
The following table shows the weighted proportion of episodes which were reported as cooking as a main activity by men and women in each survey. As can be seen,  in contrast to the unweighted proportions
...
The following chart shows the unweighted distribution of cooking as a  main activity across time of day for the different surveys.
