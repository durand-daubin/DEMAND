...
setnames(t, c("Survey", "Sex", "N episodes", 
              "Main (% of episodes)",
...
t <- cbind(t,c)
setnames(t, c("Location", "Survey", "% episodes", "lci", "uci")) # must be an easier way
t[, lci := lci * 100]
t[, uci := uci * 100]
setnames(t, c("Location", "Survey", "% episodes", "2.5%", "97.5%"))
