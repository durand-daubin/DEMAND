...
Table: MTUS survey repondents by age range and survey (unweighted)
...
Table: MTUS survey repondents by sex and survey (unweighted)
...
Table: Weighted proportion of episodes reported as cooking (with 95% CI)
...
Table: Weighted proportion of episodes reported as eating (with 95% CI)
...
![](DEMAND_Book_Ch_Dinner_files/figure-html/cookingByHalfhourEps-1.png)<!-- -->

![](DEMAND_Book_Ch_Dinner_files/figure-html/cookingByHalfhourIndicator-1.png)<!-- -->
...
![](DEMAND_Book_Ch_Dinner_files/figure-html/weekdayEatingAtHome-1.png)<!-- -->

![](DEMAND_Book_Ch_Dinner_files/figure-html/weekdayEatingAtFf-1.png)<!-- -->

![](DEMAND_Book_Ch_Dinner_files/figure-html/weekdayEatingAtWs-1.png)<!-- -->

![](DEMAND_Book_Ch_Dinner_files/figure-html/weekdayEatingOut-1.png)<!-- -->
...
Table: UK episodes per month by survey
...
Table: UK episodes per season by survey
...
Table: UK episodes per location (original) by survey
...
Table: Cooking: Half hour indicator summaries (unweighted)
...
Table: Eating: Half hour indicator summaries (unweighted)
...
![](DEMAND_Book_Ch_Dinner_files/figure-html/compareUKCookingHalfhour2005-1.png)<!-- -->
...
![](DEMAND_Book_Ch_Dinner_files/figure-html/compareUKEatingHalfhour2005-1.png)<!-- -->
...
***
__Meta:__
Analysis completed in: 11.516 seconds using [knitr](https://cran.r-project.org/package=knitr) in [RStudio](http://www.rstudio.com).
