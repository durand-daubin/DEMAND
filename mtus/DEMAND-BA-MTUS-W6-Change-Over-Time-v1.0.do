...
log using "`rpath'/DEMAND-BA-MTUS-W6-Change-Over-Time-`version'.smcl", replace
...
foreach v of local vars {
	preserve
		...
		* n per half hour = 6
		...
		sort survey day
		outsheet using "`rpath'/DEMAND-BA-MTUS-W6-Change-Over-Time-`version'-`l`v''halfhour.txt", replace
